		...
		if($_SESSION["Role"]==1)//Quản trị
{
	...
	<!-- thiết kế logo và nút tìm kiếm-->
			<div class="row align-items-center">
				<div class="col">
					<a target="#" href="https://portal.ptit.edu.vn/">
						<img width="70" height="70" src="images/logo.png" alt="TRƯỜNG PTIT">
					</a>
				</div>
			<div class="col">
...
<div class="row">
    ...
    <div class="col-md-2">
        <h6>Mạng xã hội</h6>
        <ul>
            <li><a target="#" href="https://www.youtube.com/channel/UC7u3CD-76hLw1cnrGSjsrww">Youtube</a></li>
			<li><a target="#" href="https://www.facebook.com/mloyxanh">Facebook</a></li>
            <li><a target="#" href="https://www.instagram.com/anhxanh_heart_99.98">Twitter</a></li>
